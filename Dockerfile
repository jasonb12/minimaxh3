...
COPY app.py job_store.py benchmark_timing.py gradio_queue.py generate.py spark.py turbo.py queue_generate.py ./
COPY docker/smoke.py /app/smoke.py
COPY download_spark.py ./
COPY tests ./tests
RUN python -m py_compile app.py benchmark_timing.py gradio_queue.py generate.py spark.py turbo.py
